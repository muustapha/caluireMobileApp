...
const importIosProjectVersion_1 = require("../../../../../utils/upgrade/ios/importIosProjectVersion");
...
describe('importIosProjectVersion', () => {
    it('should get project version', async () => {
        mockFs_1.mockFs.writeFileSync((0, getIosProjectPath_1.getPbxProjectPath)('/oldProject'), mockPbxProjTemplate_1.mockPbxProjTemplate.replace(new RegExp((0, escapeRegExp_1.escapeRegExp)('CURRENT_PROJECT_VERSION = 1'), 'g'), 'CURRENT_PROJECT_VERSION = 5'));
        mockFs_1.mockFs.writeFileSync((0, getIosProjectPath_1.getPbxProjectPath)(), mockPbxProjTemplate_1.mockPbxProjTemplate);
        const importGetter = (0, importIosProjectVersion_1.importIosProjectVersion)('/oldProject');
        expect(importGetter).toBeTruthy();
        expect(importGetter.value).toEqual('5');
        await importGetter.apply();
        expect(mockFs_1.mockFs.readFileSync((0, getIosProjectPath_1.getPbxProjectPath)())).toContain('CURRENT_PROJECT_VERSION = 5');
    });
    ...
    it('should handle not finding project version', () => {
        mockFs_1.mockFs.writeFileSync((0, getIosProjectPath_1.getPbxProjectPath)('/oldProject'), mockPbxProjTemplate_1.mockPbxProjTemplate.replace(new RegExp((0, escapeRegExp_1.escapeRegExp)('CURRENT_PROJECT_VERSION = 1'), 'g'), 'random = "random"'));
        const importGetter = (0, importIosProjectVersion_1.importIosProjectVersion)('/oldProject');
        expect(importGetter).toBeNull();
    });
    it('should get project version from variable', async () => {
        mockFs_1.mockFs.writeFileSync((0, getIosProjectPath_1.getPbxProjectPath)('/oldProject'), mockPbxProjTemplate_1.mockPbxProjTemplate
            .replace(new RegExp((0, escapeRegExp_1.escapeRegExp)('CURRENT_PROJECT_VERSION = 1'), 'g'), 'CURRENT_PROJECT_VERSION = "${VARIABLE}"')
        ...
        await importGetter.apply();
        expect(mockFs_1.mockFs.readFileSync((0, getIosProjectPath_1.getPbxProjectPath)())).toContain('CURRENT_PROJECT_VERSION = "${VARIABLE}"');
