...
const stdin = {
    ...
    pause: jest.fn(),
    resume: jest.fn(),
    on: jest.fn((_, listener) => listener('')),
};
describe('waitForInputToContinue', () => {
    ...
    it('should resolve with keys', async () => {
        // @ts-ignore
        process.stdin.on = jest.fn((_, listener) => {
