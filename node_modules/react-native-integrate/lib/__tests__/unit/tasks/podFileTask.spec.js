...
const podFileTask_1 = require("../../../tasks/podFileTask");
describe('podFileTask', () => {
    it('should prepend text into empty body ', async () => {
        ...
        content = await (0, podFileTask_1.podFileTask)({
...
`;
        ...
        await (0, podFileTask_1.podFileTask)({
            configPath: 'path/to/config',
            task: task,
            content,
            packageName: 'test-package',
...
`;
        ...
        await expect((0, podFileTask_1.podFileTask)({
            configPath: 'path/to/config',
...
`;
            const podFilePath = path_1.default.resolve(__dirname, `../../mock-project/ios/${constants_1.Constants.POD_FILE_NAME}`);
        ...
        it('should throw when pod file does not exist', async () => {
            ...
            await expect((0, podFileTask_1.runTask)({
                configPath: 'path/to/config',
                task: task,
                packageName: 'test-package',
