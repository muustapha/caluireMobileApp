...
const settingsGradleTask_1 = require("../../../tasks/settingsGradleTask");
...
describe('settingsGradleTask', () => {
    it('should prepend text into empty body ', async () => {
        ...
        content = await (0, settingsGradleTask_1.settingsGradleTask)({
...
`;
        ...
        await (0, settingsGradleTask_1.settingsGradleTask)({
            configPath: 'path/to/config',
            task: task,
            content,
            packageName: 'test-package',
...
`;
        ...
        await expect((0, settingsGradleTask_1.settingsGradleTask)({
            configPath: 'path/to/config',
...
`;
            const settingsGradlePath = path_1.default.resolve(__dirname, `../../mock-project/android/${constants_1.Constants.SETTINGS_GRADLE_FILE_NAME}`);
            ...
            await (0, settingsGradleTask_1.runTask)({
                configPath: 'path/to/config',
                task: task,
                packageName: 'test-package',
            });
        ...
        it('should throw when main application does not exist', async () => {
            ...
            await expect((0, settingsGradleTask_1.runTask)({
                configPath: 'path/to/config',
                task: task,
                packageName: 'test-package',
