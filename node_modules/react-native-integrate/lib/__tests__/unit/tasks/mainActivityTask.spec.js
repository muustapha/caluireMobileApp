...
const mainActivityTask_1 = require("../../../tasks/mainActivityTask");
...
describe('mainActivityTask', () => {
    it('should prepend text into empty body ', async () => {
        ...
        content = await (0, mainActivityTask_1.mainActivityTask)({
...
`;
        ...
        await (0, mainActivityTask_1.mainActivityTask)({
            configPath: 'path/to/config',
            task: task,
            content,
            packageName: 'test-package',
...
`;
        ...
        await expect((0, mainActivityTask_1.mainActivityTask)({
            configPath: 'path/to/config',
...
`;
            const mainActivityPath = path_1.default.resolve(__dirname, `../../mock-project/android/app/src/main/java/com/test/${constants_1.Constants.MAIN_ACTIVITY_JAVA_FILE_NAME}`);
            ...
            await (0, mainActivityTask_1.runTask)({
                configPath: 'path/to/config',
                task: task,
                packageName: 'test-package',
            });
...
`;
            const mainActivityPath = path_1.default.resolve(__dirname, `../../mock-project/android/app/src/main/java/com/test/${constants_1.Constants.MAIN_ACTIVITY_KT_FILE_NAME}`);
            mockFs.writeFileSync(mainActivityPath, content);
            const task = {
                task: 'main_activity',
                lang: 'kotlin',
        ...
        it('should throw when main application does not exist', async () => {
            ...
            await expect((0, mainActivityTask_1.runTask)({
                configPath: 'path/to/config',
                task: task,
                packageName: 'test-package',
