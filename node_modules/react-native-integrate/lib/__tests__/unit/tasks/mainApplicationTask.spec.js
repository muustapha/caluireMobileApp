...
const mainApplicationTask_1 = require("../../../tasks/mainApplicationTask");
...
describe('mainApplicationTask', () => {
    it('should prepend text into empty body ', async () => {
        ...
        content = await (0, mainApplicationTask_1.mainApplicationTask)({
...
`;
        ...
        await (0, mainApplicationTask_1.mainApplicationTask)({
            configPath: 'path/to/config',
            task: task,
            content,
            packageName: 'test-package',
...
`;
        ...
        await expect((0, mainApplicationTask_1.mainApplicationTask)({
            configPath: 'path/to/config',
...
`;
            const mainApplicationPath = path_1.default.resolve(__dirname, `../../mock-project/android/app/src/main/java/com/test/${constants_1.Constants.MAIN_APPLICATION_JAVA_FILE_NAME}`);
            ...
            await (0, mainApplicationTask_1.runTask)({
                configPath: 'path/to/config',
                task: task,
                packageName: 'test-package',
            });
...
`;
            const mainApplicationPath = path_1.default.resolve(__dirname, `../../mock-project/android/app/src/main/java/com/test/${constants_1.Constants.MAIN_APPLICATION_KT_FILE_NAME}`);
            mockFs.writeFileSync(mainApplicationPath, content);
            const task = {
                task: 'main_application',
                lang: 'kotlin',
        ...
        it('should throw when main application does not exist', async () => {
            ...
            await expect((0, mainApplicationTask_1.runTask)({
                configPath: 'path/to/config',
                task: task,
                packageName: 'test-package',
