...
const androidManifestTask_1 = require("../../../tasks/androidManifestTask");
const mockAll_1 = require("../../mocks/mockAll");
const mockAndroidManifestTemplate_1 = require("../../mocks/mockAndroidManifestTemplate");
describe('androidManifestTask', () => {
    it('should throw if setting attributes with empty block', async () => {
        ...
        await expect((0, androidManifestTask_1.androidManifestTask)({
    ...
    it('should prepend text into empty body without block', async () => {
        ...
        content = await (0, androidManifestTask_1.androidManifestTask)({
            configPath: 'path/to/config',
            task: task,
            content,
            packageName: 'test-package',
...
`);
    ...
    it('should skip insert when ifNotPresent exists', async () => {
        const content = mockAndroidManifestTemplate_1.mockAndroidManifestTemplate;
        const task = {
            task: 'android_manifest',
            actions: [
                {
        ...
        await (0, androidManifestTask_1.androidManifestTask)({
            configPath: 'path/to/config',
            task: task,
            content,
            packageName: 'test-package',
...
`;
            ...
            await (0, androidManifestTask_1.runTask)({
                configPath: 'path/to/config',
                task,
                packageName: 'test-package',
            });
        ...
        it('should throw when android manifest does not exist', async () => {
            ...
            await expect((0, androidManifestTask_1.runTask)({
                configPath: 'path/to/config',
                task: task,
                packageName: 'test-package',
