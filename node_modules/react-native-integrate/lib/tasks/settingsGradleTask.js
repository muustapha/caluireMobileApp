...
exports.summary = exports.runTask = exports.settingsGradleTask = void 0;
...
async function settingsGradleTask(args) {
    let { content } = args;
...
exports.settingsGradleTask = settingsGradleTask;
...
function getSettingsGradlePath() {
    ...
    const settingsGradlePath = path_1.default.join(projectPath, 'android', constants_1.Constants.SETTINGS_GRADLE_FILE_NAME);
    if (!fs_1.default.existsSync(settingsGradlePath))
...
function readSettingsGradleContent() {
    ...
    return fs_1.default.readFileSync(settingsGradlePath, 'utf-8');
}
function writeSettingsGradleContent(content) {
    const settingsGradlePath = getSettingsGradlePath();
    return fs_1.default.writeFileSync(settingsGradlePath, content, 'utf-8');
}
...
exports.summary = 'settings.gradle modification';
